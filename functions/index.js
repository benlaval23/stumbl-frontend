...
exports.getUser = onCall(async (data, context) => {
...
exports.searchUserByPhoneNumbers = onCall(async (data, context) => {
	...
	try {
		...
		if (userData.length === 0) {
			return {
				error: `No users found with phone numbers: ${phoneNumbers}`,
			};
		} else {
			return userData;
		}
